...
class flag_setup(commands.Cog):
    ...
    # Create a flag group
    flag_group = app_commands.Group(name="flag-quiz", description="Made by Milyaket#9669")
    ...
    @app_commands.describe(channel="Select your channel | Made by Milyaket#9669")
...
async def setup(bot):
    await bot.add_cog(flag_setup(bot=bot))
